...
import Style from './dine-in-experience.module.css';
                ...
                <div className={Style.pageLayout}>
                    ...
                    <div className={Style.mainContent}>
                        ...
                        <div className={Style.pageHeader}>
                            <h1 className={Style.pageTitle}>DINE-IN EXPERIENCE</h1>
                        </div>
...
export default DineInExperience;